  ...
  <div class="manage-member-container">
      ...
      <div class="user-status">
        <div
          :class="[
            ...
            {
              'apply-count-active': item.id === userCurrentStatusId,
            },
          ]"
    ...
    <div id="memberListContainer" class="member-list-container">
      <member-item
        ...
        :key="userInfo.userId"
        :user-info="userInfo"
        :user-current-status="userCurrentStatusId"
      />
    </div>
    <div
      v-if="!isGeneralUser && userCurrentStatusId !== USERS_STATUS.NOT_ENTER"
    ...
    <div
      v-if="userCurrentStatusId === USERS_STATUS.NOT_ENTER"
      class="global-setting"
    >
      <tui-button
